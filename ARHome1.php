        ...
        <nav id="sidebar">
			...
			<li  class="active">
		      ...
		      <div class="small-screen navbar-display">
                ...
                <li class="dropdown">
                    <a href="ARHomeFieldVisits.php" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                ...
                <li class="dropdown">
                    <a href="AROfficerOrders.php" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
					<i class="material-icons">apps</i><span>Orders</span></a>
				...
				<li class="dropdown">
                    <a href="ARHomeDeliverOrders.php" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
			   ...
			   <li class="dropdown">
                    <a href="ARHomeViewFarmerInfo.php" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
					<i class="material-icons">grid_on</i><span>View Farmer Info</span></a>
...
<body>
    ...
    <p>Number of Farmers who Registered With The System: <?php echo $num_farmers; ?></p>
