...
<link href="https://fonts.googleapis.com/css2?family=Roboto:wght@300;400;500;700;900&display=swap" rel="stylesheet">
	...
	<!--google material icon-->
        <link href="https://fonts.googleapis.com/css2?family=Material+Icons" rel="stylesheet">  </head>
  <body>
...
<body>
    ...
    <script type="text/javascript">
     ...
     <script>
        // Function to fetch and inject content into the sections
        function injectContent(sectionId, fileUrl) {
            fetch(fileUrl)
        ...
        // Call the function to inject content for each section
        injectContent('current-status-section', 'farmerDetailedView.php');
        injectContent('field-visits-section', 'field-visits.html');
        injectContent('view-farmer-info-section', 'view-farmer-info.html');
        // Add other sections here with corresponding file URLs
    </script>
</body>
