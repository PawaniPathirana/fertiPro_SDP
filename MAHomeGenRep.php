          ...
          <ul class="list-unstyled components">
            ...
            <div class="small-screen navbar-display">
              <li class="dropdown d-lg-none d-md-block d-xl-none d-sm-block">
                <a href="#homeSubmenu0" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                  <i class="material-icons">notifications</i><span> 4 notifications</span></a>
                <ul class="collapse list-unstyled menu" id="homeSubmenu0">
                  <li>
                    <a href="#">You have 5 new messages</a>
                  </li>
                  <li>
                    <a href="#">You're now a friend with Mike</a>
                  </li>
                  <li>
            ...
            <li class="dropdown">
                <a href="MAHomeAddStock.php" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                  <i class="material-icons">content_copy</i><span>Add Stock</span></a>
              ...
              <div class="col-md-12 right-box">
                <div class="row align-items-center">
                  <div class="header-text mb-5">
                    ...
                    <html>
                    <head>
                        <title>Select Report Category</title>
                    </head>
                    <body>
                        <div class="container">
                            ...
                            <form method="post" action="" id="reportForm">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="reportCategory" name="reportCategory" required>
                                        ...
                                        <option value="total_required_fertilizer">Total Required Fertilizer</option>
                                        <option value="current_stock_overall">Current Stock Details</option>
                        ...
                        <script>
                            // JavaScript code to redirect to the selected report file
                            document.getElementById("reportForm").addEventListener("submit", function (event) {
                                event.preventDefault(); // Prevent form submission
                                var selectedOption = document.getElementById("reportCategory").value;
                                if (selectedOption === "total_required_fertilizer") {
                                    window.location.href = "overallQun.php";
                                } else if (selectedOption === "current_stock_overall") {
                                    window.location.href = "fetch_overall_details.php";
                                } else if (selectedOption === "total_price") {
                                    window.location.href = "overallPrice.php";
                                }
                            });
                        </script>
                    </body>
